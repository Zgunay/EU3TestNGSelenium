    ...
    public void printAllCellsByIndex(){
        ...
        for (int i = 1; i <= rowNumber; i++) {
            ...
            for (int j = 1; j <= colNumber; j++) {
                System.out.println("driver.findElement(By.xpath(\"//table[@id='table1']/tbody/tr[\"+i+\"]/td[\"+j+\"]\")).getText() = " + driver.findElement(By.xpath("//table[@id='table1']/tbody/tr[" + i + "]/td[" + j + "]")).getText());
